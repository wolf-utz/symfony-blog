 ...
 */
class Version20180216155039 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE post_comment_mm (post_id INT NOT NULL, comment_id INT NOT NULL, INDEX IDX_C6A109724B89032C (post_id), UNIQUE INDEX UNIQ_C6A10972F8697D13 (comment_id), PRIMARY KEY(post_id, comment_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
